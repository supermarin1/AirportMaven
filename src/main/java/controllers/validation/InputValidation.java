...
public interface InputValidation {
    ...
    boolean passengerNationalityInputCheck(String name);
     ...
     * @return - is correct - true, not correct - false
     */
    boolean passengerNameInputCheck(String name);
     ...
     * @return - is correct - true, not correct - false
     */
    boolean passportNumberInputCheck(String passport);
     ...
     * Shoul be only numbers (can be decimal).
     *
